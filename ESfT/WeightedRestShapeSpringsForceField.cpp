...
******************************************************************************/
#define SOFA_COMPONENT_FORCEFIELD_WeightedRestShapeSpringsForceField_CPP

#include "WeightedRestShapeSpringsForceField.inl"
...
template<>
void WeightedRestShapeSpringsForceField<Rigid3Types>::addForce(const core::MechanicalParams* /* mparams */, DataVecDeriv& f, const DataVecCoord& x, const DataVecDeriv& /* v */)
{
...
template<>
void WeightedRestShapeSpringsForceField<Rigid3Types>::addDForce(const core::MechanicalParams* mparams, DataVecDeriv& df, const DataVecDeriv& dx)
{
...
template<>
void WeightedRestShapeSpringsForceField<Rigid3Types>::addKToMatrix(const core::MechanicalParams* mparams, const sofa::core::behavior::MultiMatrixAccessor* matrix )
{
    const VecReal& k = stiffness.getValue();
    const VecReal& k_a = angularStiffness.getValue();
    const int N = 6;
...
template<>
void WeightedRestShapeSpringsForceField<Rigid3Types>::draw(const core::visual::VisualParams* vparams)
{
...
int WeightedRestShapeSpringsForceFieldClass = core::RegisterObject("Elastic springs generating forces on degrees of freedom between their current and rest shape position")
        .add< WeightedRestShapeSpringsForceField<Vec3Types> >()
        .add< WeightedRestShapeSpringsForceField<Vec1Types> >()
        .add< WeightedRestShapeSpringsForceField<Rigid3Types> >()
        ;

template class SOFA_GRAPHREGISTRATION_API WeightedRestShapeSpringsForceField<Vec3Types>;
template class SOFA_GRAPHREGISTRATION_API WeightedRestShapeSpringsForceField<Vec1Types>;
template class SOFA_GRAPHREGISTRATION_API WeightedRestShapeSpringsForceField<Rigid3Types>;
