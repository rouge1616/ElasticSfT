...
class SolvePnP : public core::visual::VisualModel
{
public:
    ...
    Data<helper::vector<Vec3> > d_imagePoints;
    Data<helper::vector<Vec3> > d_objectPoints;
    Data<helper::vector<double> > d_intrinsecParam;
    Data<helper::vector<double> > d_distortionCoeff;
