...
******************************************************************************/
#ifndef Recorded2Camera_H
#define Recorded2Camera_H
...
class Recorded2Camera : public BaseCamera
{
public:
    SOFA_CLASS(Recorded2Camera, BaseCamera);

    typedef BaseCamera::Vec3 Vec3;
    typedef BaseCamera::Quat Quat;
protected:
    Recorded2Camera();
    ~Recorded2Camera() override {}
public:
    void init() override;
