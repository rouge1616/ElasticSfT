...
class MatchingEngine : public core::visual::VisualModel
{
public:
    ...
    sofa::Data<VecCoord> d_inputModelPoints;
    sofa::Data<VecCoord> d_outputSourcePoints;
    sofa::Data<VecCoord> d_outputTargetPoints;
